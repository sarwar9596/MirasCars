					...
					{loading ? (
						<div className='flex justify-center py-20'>
							<div
								...
								style={{
									borderColor: 'rgba(47,164,169,0.2)',
						...
						<>
							...
							{filteredBlogs[0] && (
								<Link
									...
									className='car-card group mb-12 block'>
									<div className='grid grid-cols-1 md:grid-cols-2'>
										...
										<div className='p-8 md:p-10 flex flex-col justify-center'>
											<span
												className='inline-block mb-3 px-3 py-1 text-xs font-bold rounded-full w-fit'
												style={{
											...
											<h2
												className='text-2xl md:text-3xl font-display font-extrabold mb-3 leading-tight'
												style={{ color: '#1A1A1A' }}>
											...
											<div
												...
												<span className='flex items-center gap-1'>
													<Calendar size={12} />
													{formatDistanceToNow(
														new Date(filteredBlogs[0].createdAt),
														{ addSuffix: true },
													)}
												</span>
												<span className='flex items-center gap-1'>
